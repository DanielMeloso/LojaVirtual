...
using System.ComponentModel.DataAnnotations; //necessário para realizar validação dos campos
...
namespace LojaVirtual.Models
{
    ...
    {
        // utilizar arquivo de recursos para exibir as mensagens de validação
